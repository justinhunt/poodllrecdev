    ...
    return {
       ...
       //insert the control bar and return it to be reused
        ...
        prepare_controlbar: function(element,controlbarid, preview, resource, mediatype){
                ...
                controls +=  '<button type="button" class="poodll_mediarecorder_button_once poodll_test-recording_once">' + ss_testlabel +  '</button>';
                ...
                var controlbar ={
                    ...
                    testbutton: $('#' + controlbarid + ' .poodll_test-recording_once'),
